...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/oxasl_ve-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12897&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/oxasl_ve-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `oxasl_ve` can be installed with:

```
conda install oxasl_ve
```

It is possible to list all of the versions of `oxasl_ve` available on your platform with:
